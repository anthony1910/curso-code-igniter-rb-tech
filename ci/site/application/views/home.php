  ...
  <main class="hoc container clear"> 
    ...
    <ul class="nospace group services">
      <li class="one_third first active">
        <article class="bgded overlay" style="background-image:url('<?php echo base_url("assets/images/demo/320x340.png"); ?>');">
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="group">
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="assets/images/demo/320x210.png" alt=""></a>
